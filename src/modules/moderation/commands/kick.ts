...
export default {
  ...
  async execute(client, interaction) {
    ...
    const isEvidenceAttached = await attachActionEvidence(client, { guildId: guild.id, actorId: actor.id, interactionId: interaction.id, evidence, outcome, result: "kick", silent });
